 ...
 * https://github.com/riscv/riscv-opcodes (4d7f46e)
 */
...
// formerly known as google3
#define MATCH_RBITSCAN 0x4000200b
#define MASK_RBITSCAN 0xfff0707f

#define MATCH_BITSCAN 0x0000200b
#define MASK_BITSCAN 0xfff0707f

// formerly known as google2
#define MATCH_SWAB32 0x0180000b
#define MASK_SWAB32 0xfff0707f

// formerly known as google0/google1
#define MATCH_GCLRBITI 0x0000100b
#define MASK_GCLRBITI 0x4000707f
#define MATCH_GCLRBIT 0x0000102b
#define MASK_GCLRBIT 0x4000707f

#define MATCH_GSETBITI 0x4000100b
#define MASK_GSETBITI 0x4000707f
#define MATCH_GSETBIT 0x4000102b
#define MASK_GSETBIT 0x4000707f
...
DECLARE_INSN(bitscan, MATCH_BITSCAN, MASK_BITSCAN)
DECLARE_INSN(rbitscan, MATCH_RBITSCAN, MASK_RBITSCAN)
DECLARE_INSN(swab32, MATCH_SWAB32, MASK_SWAB32)
DECLARE_INSN(gsetbit, MATCH_GSETBIT, MASK_GSETBIT)
DECLARE_INSN(gclrbit, MATCH_GCLRBIT, MASK_GCLRBIT)
DECLARE_INSN(gsetbiti, MATCH_GSETBITI, MASK_GSETBITI)
DECLARE_INSN(gclrbiti, MATCH_GCLRBITI, MASK_GCLRBITI)
